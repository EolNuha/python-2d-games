...
stars_img = pygame.transform.scale(pygame.image.load(os.path.join("game_assets", "star.png")),
                                   (80, 80))
start_btn = pygame.image.load(os.path.join("game_assets", "menu_button.png"))
...
side_img = pygame.transform.scale(pygame.image.load(os.path.join("game_assets", "menu2.png")),
                                  (120, 535))
down_img = pygame.transform.scale(pygame.image.load(os.path.join("game_assets", "wave3.png")),
                                  (230, 150))

buy_archer = pygame.transform.scale(
    pygame.image.load(os.path.join("game_assets/tower_sprites", "tower_sprite_000.png")),
    (75, 75))
buy_archer_2 = pygame.transform.scale(
    pygame.image.load(os.path.join("game_assets/tower_sprites", "tower_sprite_2_000.png")), (75, 75))
buy_archer_3 = pygame.transform.scale(
    pygame.image.load(os.path.join("game_assets/tower_sprites", "tower_sprite_3_000.png")), (75, 75))
buy_archer_4 = pygame.transform.scale(
    pygame.image.load(os.path.join("game_assets/tower_sprites", "tower_sprite_4_000.png")), (75, 75))
buy_damage = pygame.transform.scale(
    pygame.image.load(os.path.join("game_assets/tower_sprites", "support_tower_000.png")),
    (60, 60))
buy_range = pygame.transform.scale(
    pygame.image.load(os.path.join("game_assets/tower_sprites", "support_tower_1_000.png")),
    (60, 60))

play_btn = pygame.transform.scale(pygame.image.load(os.path.join("game_assets", "button_play.png")),
                                  (75, 75))
pause_btn = pygame.transform.scale(pygame.image.load(os.path.join("game_assets", "button_pause.png")),
                                   (75, 75))

sound_btn = pygame.transform.scale(pygame.image.load(os.path.join("game_assets", "button_sound.png")),
                                   (75, 75))
sound_btn_off = pygame.transform.scale(
    pygame.image.load(os.path.join("game_assets", "button_sound_off.png")), (75, 75))

wave_bg = pygame.transform.scale(pygame.image.load(os.path.join("game_assets", "wave1.png")), (225, 75))
